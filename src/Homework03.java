...
//        int result = sum(); //这是得到的返回值
        ...
        // 2. Callable + Future
        Future future = service.submit(Homework03::sum);
        try {
...
//        CountDownLatch countDownLatch = new CountDownLatch(1);
        ...
        CompletableFuture<Integer> cfSum = CompletableFuture.supplyAsync(Homework03::sum);
        try {
...
//            countDownLatch.await();
        ...
        CompletableFuture<Integer> cfSum6 = CompletableFuture.supplyAsync(Homework03::sum);
